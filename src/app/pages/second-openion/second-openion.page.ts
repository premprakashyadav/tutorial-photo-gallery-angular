...
@Component({
  selector: 'app-second-openion',
  templateUrl: './second-openion.page.html',
  styleUrls: ['./second-openion.page.scss'],
})
export class SecondOpenionPage implements OnInit {
...
if (this.photoService.photos.length > 0) {
    ...
    if(this.prescription.length > 0 || this.message) {
